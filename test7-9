...
class ChatApp(QWidget):
    ...
    def initUI(self):
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.web_button.setIconSize(QtCore.QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        self.web_button.setIconSize(QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.web_sec_button.setIconSize(QtCore.QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        self.web_sec_button.setIconSize(QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.mute_button.setIconSize(QtCore.QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        self.mute_button.setIconSize(QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.plus_button.setIconSize(QtCore.QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        self.plus_button.setIconSize(QSize(22, 22))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.setting_button.setIconSize(QtCore.QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        self.setting_button.setIconSize(QSize(20, 20))  # Hier Größe der SVG-Datei angeben
    ...
    def eventFilter(self, obj, event):
        buttons = {
            ...
            self.web_button: {
                QEvent.Enter: ('web-img-hover.svg', QSize(22, 22)),
                QEvent.Leave: ('web-img.svg', QSize(22, 22)),
                QEvent.MouseButtonPress: ('web-img-pressed.svg', QSize(27, 27)),
                QEvent.MouseButtonRelease: ('web-img-hover.svg', QSize(22, 22))
            },
            self.web_sec_button: {
                QEvent.Enter: ('web-sec-img-hover.svg', QSize(22, 22)),
                QEvent.Leave: ('web-sec-img.svg', QSize(22, 22)),
                QEvent.MouseButtonPress: ('web-sec-img.svg', QSize(27, 27)),
                QEvent.MouseButtonRelease: ('web-sec-img.svg-hover', QSize(22, 22))
            },
            self.plus_button: {
                QEvent.Enter: ('plus-hover.svg', QSize(22, 22)),
                QEvent.Leave: ('plus.svg', QSize(22, 22)),
                QEvent.MouseButtonPress: ('plus-pressed.svg', QSize(27, 27)),
                QEvent.MouseButtonRelease: ('plus-hover.svg', QSize(22, 22))
            },
            self.setting_button: {
                QEvent.Enter: ('settings-hover.svg', QSize(20, 20)),
                QEvent.Leave: ('settings.svg', QSize(20, 20)),
                QEvent.MouseButtonPress: ('settings-pressed.svg', QSize(25, 25)),
                QEvent.MouseButtonRelease: ('settings-hover.svg', QSize(20, 20))
            }
        }
