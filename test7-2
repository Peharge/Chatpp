...
class ChatApp(QWidget):
    ...
    def initUI(self):
        ...
        # Hinzufügen eines Schatteneffekts zum Button
        shadow_effect = QGraphicsDropShadowEffect(self.web_button)
        shadow_effect.setBlurRadius(10)
        shadow_effect.setColor(Qt.black)  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(5, 5)
        self.web_button.setGraphicsEffect(shadow_effect)
        self.web_button.setFixedSize(75, 35)
        self.web_button.setIconSize(QtCore.QSize(18, 18))  # Hier Größe der SVG-Datei angeben
        self.web_button.setIconSize(QSize(18, 18))  # Hier Größe der SsVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.web_button.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        self.web_button.setIconSize(QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        self.web_button.setIcon(QIcon('send-nor.svg'))
        ...
        # Verbinde die enterEvent und leaveEvent mit den Funktionen.
        self.web_button.enterEvent = lambda event: move_web_button_up()
        self.web_button.leaveEvent = lambda event: move_web_button_down(self.web_button)

        self.setLayout(button_layout)


        icon_pathas = 'volume-high-solid.svg'
        self.mute_button = QPushButton()
        self.mute_button.setIcon(QIcon(icon_pathas))
        ...
        shadow_effect.setColor(Qt.black)  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(5, 5)
        self.mute_button.setGraphicsEffect(shadow_effect)
        self.mute_button.setFixedSize(75, 35)
        self.mute_button.setIconSize(QtCore.QSize(20, 20))  # Hier Größe der SVG-Datei angeben
        self.mute_button.setIconSize(QSize(20, 20))  # Hier Größe der SsVG-Datei angeben
        ...
        self.mute_button.setStyleSheet("""
            QPushButton {
                ...
                color: #ffffff;
                border-radius: 5px;
                border: 2px solid qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0, stop: 0 #00ff00, stop: 1 #008000);
            }
            QPushButton:hover {
                border: 3px solid qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0, stop: 0 #ff0000, stop: 1 #008000);
            }
        ...
        # Verbinde die enterEvent und leaveEvent mit den Funktionen.
        self.mute_button.enterEvent = lambda event: move_mute_button_up()
        self.mute_button.leaveEvent = lambda event: move_mute_button_down(self.mute_button)

        self.setLayout(button_layout)

        icon_pathas = 'plus.svg'
        self.plus_button = QPushButton()
        self.plus_button.setIcon(QIcon(icon_pathas))
        ...
        shadow_effect.setColor(Qt.black)  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(5, 5)
        self.plus_button.setGraphicsEffect(shadow_effect)
        self.plus_button.setFixedSize(75, 35)
        self.plus_button.setIconSize(QtCore.QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        self.plus_button.setIconSize(QSize(25, 25))  # Hier Größe der SsVG-Datei angeben
        ...
        # Verbinde die enterEvent und leaveEvent mit den Funktionen.
        self.plus_button.enterEvent = lambda event: move_plus_button_up()
        self.plus_button.leaveEvent = lambda event: move_plus_button_down(self.plus_button)

        self.setLayout(button_layout)

        icon_pathas = 'settings.svg'
        self.setting_button = QPushButton()
        self.setting_button.setIcon(QIcon(icon_pathas))
        ...
        shadow_effect.setColor(Qt.black)  # Schwarze Farbe für den Schatten
        shadow_effect.setOffset(5, 5)
        self.setting_button.setGraphicsEffect(shadow_effect)
        self.setting_button.setFixedSize(75, 35)
        ...
        # Verbinde die enterEvent und leaveEvent mit den Funktionen.
        self.setting_button.enterEvent = lambda event: move_setting_button_up()
        self.setting_button.leaveEvent = lambda event: move_setting_button_down(self.setting_button)
    ...
    def eventFilter(self, obj, event):
        if obj == self.send_button:
            if event.type() == QEvent.Enter:
                self.send_button.setIcon(QIcon('send-hover.svg'))
                self.send_button.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
            elif event.type() == QEvent.Leave:
                self.send_button.setIcon(QIcon('send-nor.svg'))
                self.send_button.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
            elif event.type() == QEvent.MouseButtonPress:
                self.send_button.setIcon(QIcon('send-pressed.svg'))
                self.send_button.setIconSize(QtCore.QSize(55, 55))  # Hier Größe der SVG-Datei angeben
            elif event.type() == QEvent.MouseButtonRelease:
                self.send_button.setIcon(QIcon('send-hover.svg'))
                self.send_button.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        return super(ChatApp, self).eventFilter(obj, event)

    def webevent(self, obj, event):
        if obj == self.web_button:  # Vergleiche mit dem tatsächlichen Objekt
            if event.type() == QEvent.Enter:
                self.web_button.setIcon(QIcon('send-hover.svg'))
                self.web_button.setIconSize(QtCore.QSize(50, 50))
            elif event.type() == QEvent.Leave:
                self.web_button.setIcon(QIcon('send-nor.svg'))
                self.web_button.setIconSize(QtCore.QSize(50, 50))
            elif event.type() == QEvent.MouseButtonPress:
                self.web_button.setIcon(QIcon('send-pressed.svg'))
                self.web_button.setIconSize(QtCore.QSize(55, 55))
            elif event.type() == QEvent.MouseButtonRelease:
                self.web_button.setIcon(QIcon('send-hover.svg'))
                self.web_button.setIconSize(QtCore.QSize(50, 50))
        return super(ChatApp, self).eventFilter(obj, event)
        ...
        if self.is_muted:
            ...
            self.mute_button.setStyleSheet("""
                QPushButton {
                    ...
                    border-radius: 5px;
                    border: none;
                    border: 2px solid qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0, stop: 0 #ff0000, stop: 1 #008000);
                }
                QPushButton:hover {
                    border: 3px solid qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0, stop: 0 #00ff00, stop: 1 #008000);
                }
    ...
    def open_settings_window(self):
        ...
        settings_window.setGeometry(760, 400, 400, 300)
        ...
        # Benutzernamen und Passwörter aus der JSON-Datei hinzufügen
        for benutzer, passwort in accounts.items():
            name_edit = QLineEdit()
            name_edit.setText(benutzer)
            name_edit.setReadOnly(True)  # Damit der Benutzername nicht verändert werden kann

            passwort_edit = QLineEdit()
            passwort_edit.setText(passwort)
            passwort_edit.setReadOnly(True)  # Damit das Passwort nicht verändert werden kann

            general_layout.addRow("user name:", name_edit)
            general_layout.addRow("user password:", passwort_edit)
        ...
        network_layout.addRow("IP Adresse:", QLineEdit())
        network_layout.addRow("Port:", QLineEdit())
        ...
        ui_layout.addRow("Thema:", QLineEdit())
        ui_tab.setLayout(ui_layout)
        tabs.addTab(ui_tab, "Benutzeroberfläche")

        # Setze Hintergrundfarbe der Tabs auf weiß
        tabs.setStyleSheet("QWidget { background-color: white; }")
        ...
        """)
        closeButton.clicked.connect(settings_window.close)
