...
class ChatApp(QWidget):
    ...
    def initUI(self):
        ...
        self.mute_button.setFixedSize(30, 35)
        ...
        self.mute_button.released.connect(lambda: move_plus_button_down(self.mute_button))
        ...
        self.setting_button.setFixedSize(30, 35)
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.setting_button.setIconSize(QtCore.QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        self.setting_button.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        self.setting_button2.setFixedSize(30, 35)
    ...
    def toggle_mute(self):
        ...
        if self.is_muted:
            ...
            # Set unmuted icon and hover icon
