...
class ChatApp(QWidget):
    ...
    def initUI(self):
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.web_button.setIconSize(QtCore.QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        self.web_button.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.mute_button.setIconSize(QtCore.QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        self.mute_button.setIconSize(QSize(50, 50))  # Hier Größe der SVG-Datei angeben
        self.mute_button.setIcon(QIcon('send-nor.svg'))
    ...
    def eventFilter(self, obj, event):
        buttons = {
            ...
            self.web_button: {
                QEvent.Enter: ('web-img-hover.svg', QSize(30, 30)),
                QEvent.Leave: ('web-img.svg', QSize(30, 30)),
                QEvent.MouseButtonPress: ('web-img-pressed.svg', QSize(35, 35)),
                QEvent.MouseButtonRelease: ('web-img-hover.svg', QSize(30, 30))
            },
            self.mute_button: {
                QEvent.Enter: ('volume-high-solid-hover.svg', QSize(30, 30)),
                QEvent.Leave: ('volume-high-solid.svg', QSize(30, 30)),
                QEvent.MouseButtonPress: ('volume-high-solid-pressed.svg', QSize(35, 35)),
                QEvent.MouseButtonRelease: ('volume-high-solid-hover.svg', QSize(30, 30))
            }
        }
