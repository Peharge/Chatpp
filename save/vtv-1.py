...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.animation_label.setFixedSize(500, 284)
        ...
        """)
        self.button.setGeometry(200, 300, 100, 50)
        ...
        self.result_label.setGeometry(50, 250, 300, 50)
    ...
    def process_audio(self, audio):
        try:
            ...
            llama3_output = run_command_and_get_output("ollama run llama3", text)
