...
class ChatApp(QWidget):
    ...
    def initUI(self):
        ...
        self.web_button.setFixedSize(35, 35)
        ...
        self.web_sec_button.setFixedSize(35, 35)
        ...
        self.web_sec_button.clicked.connect(self.open_settings_window)
        # Icon-Größe auf die gewünschte Größe setzen
        self.web_sec_button.setIconSize(QtCore.QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        self.web_sec_button.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        self.mute_button.setFixedSize(35, 35)
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.mute_button.setIconSize(QtCore.QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        self.mute_button.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.plus_button.setIconSize(QtCore.QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        self.plus_button.setIconSize(QSize(30, 30))  # Hier Größe der SVG-Datei angeben
        ...
        self.setting_button.setFixedSize(35, 35)
        ...
        # Icon-Größe auf die gewünschte Größe setzen
        self.setting_button.setIconSize(QtCore.QSize(25, 25))  # Hier Größe der SVG-Datei angeben
        self.setting_button.setIconSize(QSize(25, 25))  # Hier Größe der SVG-Datei angeben
    ...
    def eventFilter(self, obj, event):
        buttons = {
            ...
            self.web_sec_button: {
                QEvent.Enter: ('web-sec-img-hover.svg', QSize(30, 30)),
                QEvent.Leave: ('web-sec-img.svg', QSize(30, 30)),
                QEvent.MouseButtonPress: ('web-sec-img.svg', QSize(35, 35)),
                QEvent.MouseButtonRelease: ('web-sec-img.svg-hover', QSize(30, 30))
            },
            self.plus_button: {
                QEvent.Enter: ('plus-hover.svg', QSize(30, 30)),
                QEvent.Leave: ('plus.svg', QSize(30, 30)),
                QEvent.MouseButtonPress: ('plus-pressed.svg', QSize(35, 35)),
                QEvent.MouseButtonRelease: ('plus-hover.svg', QSize(30, 30))
            },
            self.setting_button: {
                QEvent.Enter: ('settings-hover.svg', QSize(25, 25)),
                QEvent.Leave: ('settings.svg', QSize(25, 25)),
                QEvent.MouseButtonPress: ('settings-pressed.svg', QSize(30, 30)),
                QEvent.MouseButtonRelease: ('settings-hover.svg', QSize(25, 25))
            }
        }
